...
exports.RichEditorTooltip = void 0;
...
const Tooltip = quill_1.default.import("ui/tooltip");
class RichEditorTooltip extends Tooltip {
    ...
    listen() {
        ...
        this.textarea.addEventListener("input", () => {
            window.katex.render(this.textarea.value, this.katexPreview, {
                throwOnError: false,
                errorColor: "#f00",
            });
        });
        ...
        this.root
            ...
            .addEventListener("click", (event) => {
            if (this.range != null) {
                const mode = this.root.getAttribute("data-mode"), range = this.range;
                this.restoreFocus();
                if (mode === "link") {
        ...
        this.quill.on("selection-change", (range, _oldRange, source) => {
            ...
            if (range.length === 0 && source === "user") {
                ...
                if (link != null) {
                    ...
                    this.show();
                    this.position(this.quill.getBounds(this.range.index, this.range.length));
                ...
                if (formula != null) {
                    ...
                    window.katex.render(preview, this.spanPreview, {
                        throwOnError: false,
                        errorColor: "#f00",
                    });
                    this.show();
...
exports.RichEditorTooltip = RichEditorTooltip;
